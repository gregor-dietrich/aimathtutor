...
- **Use `QuarkusSecurityIdentity.builder(identity)` when augmenting** — it preserves credentials, attributes, and permission checkers. Using `builder()` loses original roles.
