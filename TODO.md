...
- ExerciseWorkspaceView
  - Title, Description, Difficulty should be layouted properly
- SessionDetailView
  - Session Details layout should be completely reworked instead of being just all the data in a list.
  - Interactions & Feedback only includes the messages auto-generated by the AI tutor but is missing student questions and the associated AI tutor answers
- StudentProgressView and StudentSessionsView
  - Both views are missing the filters and refresh button that all other admin views have
