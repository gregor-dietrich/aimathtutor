...
class GoogleRequestDtoTest {

    @Test
    @DisplayName("Default constructor has null fields")
    void testDefaultConstructor() {
        final var dto = new GoogleRequestDto();
    ...
    void testContentDefault() {
        final var content = new GoogleRequestDto.Content();
    ...
    void testContentTextConstructor() {
        final var content = new GoogleRequestDto.Content("Hello");
    ...
    void testPartDefault() {
        final var part = new GoogleRequestDto.Part();
    ...
    void testPartTextConstructor() {
        final var part = new GoogleRequestDto.Part("text");
    ...
    void testGenerationConfigDefault() {
        final var config = new GoogleRequestDto.GenerationConfig();
    ...
    void testGenerationConfigParameterized() {
        final var config = new GoogleRequestDto.GenerationConfig(0.7, 100);
    ...
    void testSafetySettingDefault() {
        final var setting = new GoogleRequestDto.SafetySetting();
    ...
    void testSafetySettingParameterized() {
        final var setting = new GoogleRequestDto.SafetySetting("HARM_CATEGORY_HARASSMENT", "BLOCK_LOW_AND_ABOVE");
    ...
    void testCreateTextRequest() {
        final var request = GoogleRequestDto.createTextRequest("prompt", 0.5, 200);
