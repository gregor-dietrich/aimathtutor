...
public class ExerciseDto {
    ...
    /**
     * Enumeration of difficulty levels for exercises and math problems. Maps to string values stored in the database
     * and used in UI components.
     */
    ...
    public static class LessonField {
         ...
         *
         * @param publicId
         *            the lesson's public identifier
         */
    ...
    /**
     * Synchronizes the nested user and lesson fields with their flat public ID fields. When both a nested object and
     * its corresponding flat field are present and non-null, the nested object's publicId takes precedence and will
        ...
        if (this.lesson != null && this.lesson.publicId != null) {
            if (this.lessonPublicId != null && !this.lesson.publicId.equals(this.lessonPublicId)) {
                LOG.warnf("Conflict in syncNestedFields: lesson.publicId (%s) differs from lessonPublicId (%s). "
                        + "Using nested value.", this.lesson.publicId, this.lessonPublicId);
            }
