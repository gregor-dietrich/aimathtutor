...
@NamedQueries({
        @NamedQuery(name = "UserRank.findAll", query = "FROM UserRankEntity ORDER BY created DESC"),
        ...
        @NamedQuery(name = "UserRank.searchByName", query = "FROM UserRankEntity WHERE LOWER(name) LIKE :s ORDER BY created DESC")
})
