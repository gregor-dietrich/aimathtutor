 ...
 *
 * <p>
 * Provides a standard layout with title, form area, and save/cancel buttons. Subclasses populate the form and handle
 * the save action.
 * </p>
 *
 * @param <T>
 *            the type of bean managed by this dialog
 */
public abstract class BaseFormDialog<T> extends Dialog {
     ...
     *
     * @param bean
     *            the bean to edit, or null for a new instance
     */
