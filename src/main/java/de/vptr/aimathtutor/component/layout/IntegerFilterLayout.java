...
/**
 * Composite layout containing an integer input field and a filter button. Parent views can read the entered integer and
 * trigger the filter using the exposed button. Designed for compact numeric filters in list views.
 */
public class IntegerFilterLayout extends HorizontalLayout {
     ...
     */
    public IntegerFilterLayout(final ComponentEventListener<ClickEvent<Button>> filterAction, final String tooltipText,
            final String fieldLabel, final String fieldWidth) {
    ...
    /**
     * Return the internal filter button so callers can attach listeners or programmatically trigger the filter action.
     *
     * @return filter button contained in this layout
     */
    @SuppressFBWarnings(value = "EI_EXPOSE_REP",
            justification = "Expose button intentionally for parent views to trigger filter actions")
    public Button getButton() {
        return this.button;
    }

    /**
     * Return the integer field used to enter the filter value. Parent views can read or set the value and attach
     * listeners as needed.
     *
     * @return the integer input field
     */
    @SuppressFBWarnings(value = "EI_EXPOSE_REP",
            justification = "Expose IntegerField intentionally for parent views to read/set values")
