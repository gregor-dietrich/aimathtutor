...
/**
 * Adds a date filter and reset button to a SearchLayout, eliminating duplication across admin views that share this
 * filter pattern.
 */
public final class SearchFilterBar {
    ...
    /**
     * Creates a date filter and reset button, attaching them to the given SearchLayout.
     *
     * @param searchLayout
     *            the SearchLayout to augment
     * @param onDateFilter
     *            callback invoked when date range changes
     * @param onResetFilters
     *            callback invoked when reset button is clicked
     */
    public SearchFilterBar(final SearchLayout searchLayout, final Runnable onDateFilter,
            final Runnable onResetFilters) {
