...
/**
 * Composite layout containing a search text field and a search button. The component wires default Enter key handling
 * and exposes internal components for parent views to reuse.
 */
public class SearchLayout extends HorizontalLayout {
     ...
     *
     * @param listener
     *            the value change listener for the text field
     * @param searchAction
     ...
     *
     * @param listener
     *            value change listener for the text field
     * @param searchAction
    ...
    /**
     * Return the internal search button. Useful to trigger a search from the parent view or to attach additional
     * listeners.
     *
     * @return the search button
     */
    @SuppressFBWarnings(value = "EI_EXPOSE_REP",
            justification = "Expose button intentionally so parent views can trigger searches or reuse it")
    public Button getButton() {
        return this.button;
    }

    /**
     * Return the text field used for entering the search term. Parent views can read or set the value and attach
     * listeners as needed.
     *
     * @return the search text field
     */
    @SuppressFBWarnings(value = "EI_EXPOSE_REP",
            justification = "Expose textField intentionally so parent views can read/set value and attach listeners")
